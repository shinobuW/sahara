...
public class HighlightRowFactory<T> implements
     ...
     */
    public HighlightRowFactory(String styleClass, Callback<TableView<T>, TableRow<T>> baseFactory) {
     ...
     * @param styleClass
     */
    public HighlightRowFactory(String styleClass) {
