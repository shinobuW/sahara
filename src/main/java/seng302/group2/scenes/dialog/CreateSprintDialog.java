...
public class CreateSprintDialog extends Dialog<Map<String, String>> {
    ...
    public CreateSprintDialog() {
        ...
        sprintEndDatePicker.getDatePicker().setDayCellFactory(dayCellFactory);
        ...
        sprintEndDatePicker.getDatePicker().valueProperty().addListener(new ChangeListener<LocalDate>() {
                ...
                public void changed(ObservableValue<? extends LocalDate> observable,
                                    LocalDate oldValue, LocalDate newValue) {
                    createButton.setDisable(!(correctShortName && correctLongName && backlogSelected()
                            && teamSelected() && releaseSelected() && startDateSelected() && endDateSelected()));
